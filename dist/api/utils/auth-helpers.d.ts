 ...
 */
export declare const isSameUser: (userId1?: string, userId2?: string) => boolean;
/**
 * Checks if a user has an admin role
 * @param userRole The user's role
 * @returns True if the user is an admin, false otherwise
 */
export declare const isAdminUser: (userRole?: string) => boolean;
/**
 ...
 */
export declare const canModifyResource: (userId?: string, resourceOwnerId?: string, userRole?: string) => boolean;
