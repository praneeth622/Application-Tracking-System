...
import { FileText, X, FileUp, CheckCircle, AlertCircle, CloudUpload, Sparkles } from "lucide-react"
        ...
        async () => {
          try {
            ...
            const selectedVendorObj =
              selectedVendor === "no-vendor" ? null : vendors.find((v) => v.id === selectedVendor)
